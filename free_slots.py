...
def free_slots(models, db, uid, password):
    try:
        ...
        slot_api_url = (
            f'https://crm.gestiones-empresariales-campeche.online/available_slots?start_time={start_time}&end_time={end_time}&company_id={company_id}'
        )
        ...
        event_api_url = (
            f'https://crm.gestiones-empresariales-campeche.online/events?start_time={start_time}&end_time={end_time}&company_id={company_id}'
        )
